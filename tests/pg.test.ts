...
const aggregateCountObject = z.object({
    count: z.number(),
});
            ...
            .object({
                queries: z
                    .object({
                        users: z
                            ...
                            .strict(),
                        usersCount: aggregateCountObject,
                        usersSingle: z
                            .object({
                                args: z
                                    .object({
                        ...
                        posts: z
                            ...
                            .strict(),
						postsCount: aggregateCountObject,
						postsSingle: z
                            .object({
                                args: z
                                    .object({
                        ...
                        customers: z
                            ...
                            .strict(),
                        customersCount: aggregateCountObject,
                        customersSingle: z
                            .object({
                                args: z
                                    .object({
                ...
                inputs: z
                    .object({
                        ...
                        CustomersInsertInput: z.instanceof(
                            GraphQLInputObjectType
                        ),
                        CustomersUpdateInput: z.instanceof(
                            GraphQLInputObjectType
                        ),
                    })
                    .strict(),
        ...
        expectTypeOf(ctx.entities.queries).toEqualTypeOf<
            {
                readonly customers: {
                    ...
                    resolve: SelectResolver<
                        ...
                        typeof schema.customersRelations extends Relations<
                            any,
                            infer RelConf
                        >
                            ? RelConf
                ...
                readonly posts: {
                    ...
                    resolve: SelectResolver<
                        typeof schema.Posts,
                        ExtractTables<typeof schema>,
                        typeof schema.postsRelations extends Relations<
                            any,
                            infer RelConf
                        >
                            ? RelConf
                ...
                readonly users: {
                    ...
                    resolve: SelectResolver<
                        typeof schema.Users,
                        ExtractTables<typeof schema>,
                        typeof schema.usersRelations extends Relations<
                            any,
                            infer RelConf
                        >
                            ? RelConf
